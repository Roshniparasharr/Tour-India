...
<header>
    ...
    <a href="#" class="logo"><span>TourIndia</span></a>
    ...
    <nav class="navbar">
        ...
        <?php
            echo "<a href='profile.php'>Hello, " . $_SESSION['email'] . "!</a>";
        ?>
...
<section class="products" id="products">
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    ...
                    <a href="../viewjourney.php?city=Manali&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    ...
                    <a href="../viewjourney.php?city=Rajasthan&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    ...
                    <a href="../viewjourney.php?city=Ladakh&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
    ...
    <div class="image">
        ...
        <div class="icons">
            ...
            <a href="../viewjourney.php?city=Chennai&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
...
<div class="box">
    <div class="image">
        ...
        <div class="icons">
            ...
            <a href="../viewjourney.php?city=Kerala&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
...
<div class="box">
    <div class="image">
        ...
        <div class="icons">
        <a href="../viewjourney.php?city=Goa&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
        </div>
    </div>
    <div class="content">
        <h3>Goa</h3>
...
<div class="box">
    <div class="image">
        ...
        <div class="icons">
            ...
            <a href="../viewjourney.php?city=Sikkim&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
        </div>
    </div>
    <div class="content">
        <h3>Sikkim</h3>
...
<div class="box">
    <div class="image">
        ...
        <div class="icons">
            ...
            <a href="../viewjourney.php?city=Pune&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
        </div>
    </div>
    <div class="content">
        <h3>Pune</h3>
...
<div class="box">
    <div class="image">
        ...
        <div class="icons">
            ...
            <a href="../viewjourney.php?city=Mumbai&email=<?php echo urlencode($_SESSION['email']); ?>" class="cart-btn">Visit Us</a>
        </div>
    </div>
    <div class="content">
        <h3>Mumbai</h3>
...
<div class="center-container">
    <a href="./reviewsedit.php" id="viewReviewsBtn">View Reviews</a>
</div>
